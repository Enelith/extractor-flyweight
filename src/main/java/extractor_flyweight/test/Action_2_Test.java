...
import extractor_flyweight.model.action.Action_2;
 ...
 * @author jvinh
 */
public class Action_2_Test {

    public static void main(String[] args) {
	boolean fullDisplayMode = true;
	
	Action_2 action = new Action_2();
	...
	component_3.setRandomInfo("Random Info 1");
	component_3_List.add(component_3);
	...
	action.setComponent_2(component_2);
